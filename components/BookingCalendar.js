...
export default function BookingCalendar({
  ...
  const handleCreateSubmit = async (event) => {
    ...
    await onCreateBooking({
      ...
      paraPihak: formState.paraPihak.trim() || null,
      divisi: formState.divisi.trim() || null,
          ...
          <section className="rounded-2xl border border-slate-200 bg-white p-4">
            ...
            <form className="grid gap-3" onSubmit={handleCreateSubmit}>
              <div className="grid gap-2">
                ...
                <div className="grid gap-2">
                  <div>
                    <label htmlFor="room-select" className="block text-xs font-medium text-slate-700 mb-1">Ruangan *</label>
                    <select
                      id="room-select"
                      className={fieldClass}
                ...
                <div className="grid grid-cols-2 gap-2">
                  <div>
                    <label htmlFor="booked-for-name" className="block text-xs font-medium text-slate-700 mb-1">Atas Nama</label>
                    <input
                      id="booked-for-name"
                      className={fieldClass}
                      type="text"
                  ...
                  <div>
                    <label htmlFor="booked-for-company" className="block text-xs font-medium text-slate-700 mb-1">Instansi / Perusahaan</label>
                    <input
                ...
                <div className="grid grid-cols-2 gap-2">
                  ...
                  <div>
                    <label htmlFor="divisi" className="block text-xs font-medium text-slate-700 mb-1">Divisi</label>
                    <input
                      id="divisi"
                      className={fieldClass}
                      type="text"
                      ...
                      onChange={(event) =>
                        setFormState((prev) => ({ ...prev, divisi: event.target.value }))
                      }
                ...
                <div className="grid grid-cols-2 gap-2">
                  <div>
                    <label htmlFor="check-in-time" className="block text-xs font-medium text-slate-700 mb-1">Jam Masuk *</label>
                    <input
                      id="check-in-time"
                      className={fieldClass}
                      type="time"
                  ...
                  <div>
                    <label htmlFor="check-out-time" className="block text-xs font-medium text-slate-700 mb-1">Jam Keluar *</label>
                    <input
                      id="check-out-time"
                      className={fieldClass}
                      type="time"
                ...
                <div>
                  <label htmlFor="num-guests" className="block text-xs font-medium text-slate-700 mb-1">Jumlah Peserta *</label>
                  <input
                    id="num-guests"
                    className={fieldClass}
                    type="number"
                ...
                <div>
                  <label htmlFor="purpose" className="block text-xs font-medium text-slate-700 mb-1">Tujuan / Judul Rapat</label>
                  <input
                    id="purpose"
                    className={fieldClass}
                    type="text"
